...
class SendMoney10 extends StatefulWidget {
  const SendMoney10({Key? key}) : super(key: key);

  @override
  State<SendMoney10> createState() => _SendMoney10State();
}

class _SendMoney10State extends State<SendMoney10> {
  int selected = 0;
  int home = 0;
          ...
          child: Column(
            ...
            children: [
              InkResponse(
                  ...
                  child: Icon(Icons.arrow_back_rounded, size: 29)),
